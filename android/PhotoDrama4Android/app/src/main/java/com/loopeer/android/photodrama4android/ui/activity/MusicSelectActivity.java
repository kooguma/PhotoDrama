...
import com.loopeer.android.photodrama4android.ui.adapter.MusicSelectAdapter;
...
public class MusicSelectActivity extends PhotoDramaBaseActivity
    implements IPageRecycler<Voice>, MusicSelectAdapter.IMusicAdapter {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        mMusicSelectAdapter = new MusicSelectAdapter(this);
