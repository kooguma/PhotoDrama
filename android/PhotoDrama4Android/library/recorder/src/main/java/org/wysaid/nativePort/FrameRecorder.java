...
//    }
    ...
    public void addAudioFrame(String filePath) {
        if (mNativeAddress != 0) {
            nativeAddAudioFrame(mNativeAddress, filePath);
        }
    }
...
//    private native boolean nativeResumeRecording(long holder);
    ...
    private native void nativeAddAudioFrame(long holder, String filename);
