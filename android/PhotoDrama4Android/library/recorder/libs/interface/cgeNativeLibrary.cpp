 ...
 */
JNIEXPORT jobject JNICALL Java_org_wysaid_nativePort_NativeLibrary_cgeFilterImage_1MultipleEffects
 ...
 */
JNIEXPORT void JNICALL Java_org_wysaid_nativePort_NativeLibrary_cgeFilterImage_1MultipleEffectsWriteBack
  (JNIEnv *env, jclass cls, jobject bmp, jstring config, jfloat intensity)
{
	static CGETexLoadArg texLoadArg;
	texLoadArg.env = env;
...
JNIEXPORT jlong JNICALL Java_org_wysaid_nativePort_NativeLibrary_cgeCreateFilterWithConfig
...
JNIEXPORT void JNICALL Java_org_wysaid_nativePort_NativeLibrary_cgeDeleteFilterWithAddress
...
JNIEXPORT jlong JNICALL Java_org_wysaid_nativePort_NativeLibrary_cgeCreateBlendFilter
