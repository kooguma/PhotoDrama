...
#define  CGE_LOG_INFO(...) __android_log_print(4, CGE_LOG_TAG, __VA_ARGS__)
#define  CGE_LOG_ERROR(...) __android_log_print(6, CGE_LOG_TAG, __VA_ARGS__)
#define  CGE_LOG_ERROR_V(...) __android_log_vprint(6, CGE_LOG_TAG, __VA_ARGS__)
#else
#define  CGE_LOG_INFO(...)
